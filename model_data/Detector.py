...
class Detector:
    ...
    def onVideo(self):
        ...
        while success:
            ...
            classLabalIds,confidences,bboxs=self.net.detect(image,confThreshold=0.5)
            bboxs=list(bboxs)
            ...
            if(len(bboxIdx)!= 0):
                for i in range(0,len(bboxIdx)):
                    ...
                    classLabelId=np.squeeze(classLabalIds[np.squeeze(bboxIdx[i])])
